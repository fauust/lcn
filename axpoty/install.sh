...
scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null "$SERVICES_SCRIPT" apache2.sh php.sh composer.sh laravel.sh create_user.sql mariadb.sh data_dump.sql welcome.blade.php "$USER@$SERVER:/home/$USER/"
